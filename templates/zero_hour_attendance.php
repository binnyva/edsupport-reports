...
<script type="text/javascript">
  ...
  function drawChart() {
	var data = google.visualization.arrayToDataTable([
		['Weekly Zero Hour Attendance', '% of Zero Hour Attendance'],
	...
	var options = {
		title: 'Weekly Zero Hour Attendance',
		vAxis: {
			viewWindow: {
				max:100,
				min:0
...
function drawPie() {
	var data = google.visualization.arrayToDataTable([
		['Year', '% of Zero Hour Attended'],
		['Zero Hour Attended',<?php echo $annual_data['percentage'] ?>],
		['Zero Hour Missed',	<?php echo 100 - $annual_data['percentage'] ?>],
	]);

	var options = {
		title: 'Annual Zero Hour Attendance',
	};
